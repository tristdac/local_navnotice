...
$string['studentemailpattern'] = 'Student Email Pattern';
$string['studentemailpatterndesc'] = 'Regular expression pattern to match student email addresses';
$string['staffemailpattern'] = 'Staff Email Pattern';
$string['staffemailpatterndesc'] = 'Regular expression pattern to match staff email addresses';
